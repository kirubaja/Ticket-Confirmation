...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Thank you for purchasing tickets at TixBox! Your transaction has been successfully completed.</p>
            <p><b>Order Confirmation Number: </b>994-494-zcmhf</p>
            
            <p>To view and print your tickets, please click the button below, which will redirect you to the "My <br>Tickets" section in your TixBox account:</p>
            <a href="mailto:support@tixbox.com" class="verify-button">View My Tickets</a><br>
            <p><b>Important:</b> Please ensure that your TixBox account information, including your name, email<br> address, and phone number, is up to date. This will allow us to contact you promptly in case of<br> any changes to the event details.</p>
          
            <p>We also recommend reviewing our <span style="color: #5CB8E1;">Terms and Conditions</span> before attending the event.<br> If you have any questions or need assistance, please feel free to contact us at support@tixbox.com.</p>
